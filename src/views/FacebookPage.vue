  ...
  <div class="content d-flex align-items-center">
    <div class="dl w-100">
      <div class="head mb-4 text-center">
        ...
        <p class="text-muted">Download Facebook Video or Audio — pilih format sebelum cari</p>
      </div>
...
async function onSearch(){
  if (!url.value || !/^(https?:\/\/)?(www\.)?(facebook\.com|fb\.watch|m\.facebook\.com)\//.test(url.value)) {
    await Swal.fire('Invalid URL', 'Masukkan URL Instagram yang valid', 'warning');
    return;
  }
  loading.value = true;
